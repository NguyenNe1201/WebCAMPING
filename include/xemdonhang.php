...
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3" style="    color: #E64419; font-weight: 600;">Xem đơn hàng</h3>
			<!-- //tittle heading -->
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						<!-- first section -->
							...
							<div class="col-md-12">
								...
								<table class="table table-bordered ">
									...
									<tr>
										...
										<td><a  style="color: #717fe0 !important;" href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>">Xem chi tiết</a></td>
										<td><?php 
										...
										<td>
											...
											?>
											<a style="color: #717fe0 !important;" href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>&huydon=1">Yêu cầu hủy</a>
											<?php
										}elseif($row_donhang['huydon']==1){											
											?>
											<p style="color: #fb5849!important;">Đang chờ hủy...</p>
											<?php
											}else{
												echo '<p style="color: #717fe0 !important;">Đã hủy </p>';
											}
											?>
										</td>
									</tr>
							...
							<div class="col-md-12">
							<!-- <h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3" style="    color: #E64419; font-weight: 600;">Xem đơn hàng</h3> -->
								<h3 style="    color: #E64419; font-weight: 600;">Chi tiết đơn hàng</h3><br>
								<?php
